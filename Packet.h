...
public:
    ...
    static int DecodeAddrStr(unsigned char *&ioData, size_t &ioDataLen, string &outString);
    static int EncodeAddrStr(unsigned char *&ioData, size_t &ioDataLen, size_t &ioRemainsLen,
                             string &inString);
